...
title("Train (Nonlinear Quantum)")
if not(exist('hide', 'var'))
    saveas(gcf, "../../images/quantum_nonlin_data.png");
end
...
if not(exist('hide','var'))
    ...
    imwrite(F.cdata, '../../images/quantum_nonlin_prog.png');
end
...
title("Test (Nonlinear Quantum)")
if not(exist('hide', 'var'))
    saveas(gcf, "../../images/quantum_nonlin_test.png")
end

figure()
confusionchart(trueLabels,predictedLabels)
title("Confusion Matrix (Nonlinear Quantum)")
if not(exist('hide', 'var'))
    saveas(gcf, "../../images/quantum_nonlin_conf.png")
end
